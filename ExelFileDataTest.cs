using DataDrivenTestForZippopotamus.us;
...
namespace Tests_Data_Driven
{
    class ExcelFileDataTests
    {
        ...
        static IEnumerable<TestCaseData> LoadTestDataFromExcel()
        {
            ...
            using (var sheet = new SLDocument(@"C:\Users\stoia\source\repos\DataDrivenTestForZippopotamus.us\DataDrivenTestForZippopotamus.us/ZippopotamousData.xlsx"))
            {
